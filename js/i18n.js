/* Kıbrıs Temizlik - Çok Dilli Site (TR / EN / DE / RU) */
(function () {
  'use strict';
  ...
  var META = {
    tr: {
      title: 'Kıbrıs Temizlik Şirketi | Ev, Ofis, Derin Temizlik & Halı Yıkama',
      description: "Kıbrıs temizlik şirketi: profesyonel ev temizliği, ofis temizliği, derin temizlik, halı & koltuk yıkama, cam ve dış cephe temizliği, inşaat sonrası temizlik ve dezenfeksiyon. Günlük ve saatlik temizlikçi, tatil evi & villa temizliği. Lefkoşa, Girne, Gazimağusa, İskele aynı gün hizmet. ☎ 0534 350 36 30"
    },
    en: {
      title: 'Cyprus Cleaning Company | Home, Office, Deep Cleaning & Carpet Wash',
      description: 'Cyprus cleaning company: professional home cleaning, office cleaning, deep cleaning, carpet & sofa washing, window and facade cleaning, post-construction cleaning and disinfection. Daily & hourly cleaners, holiday home & villa cleaning. Nicosia, Kyrenia, Famagusta same-day service. ☎ +90 534 350 36 30'
    },
    de: {
      title: 'Reinigungsfirma Zypern | Haus, Büro, Tiefenreinigung & Teppichwäsche',
      description: 'Reinigungsfirma in Zypern: professionelle Wohnungsreinigung, Büroreinigung, Tiefenreinigung, Teppich- & Polsterwäsche, Fenster- und Fassadenreinigung, Baureinigung und Desinfektion. Ferienwohnungs- & Villenreinigung. Nicosia, Kyrenia, Famagusta Service am selben Tag. ☎ +90 534 350 36 30'
    },
    ru: {
      title: 'Клининговая компания на Кипре | Дом, офис, генуборка, химчистка',
      description: 'Клининговая компания на Кипре: профессиональная уборка квартир и офисов, генеральная уборка, химчистка ковров и диванов, мытье окон и фасадов, послестроительная уборка и дезинфекция. Никосия, Кирения, Фамагуста обслуживание в тот же день. ☎ +90 534 350 36 30'
    }
  };
  ...
  var TR = {
    ...
    'hero.badge': '7/24 Kıbrıs Temizlik Şirketi',
    'hero.title': "Kıbrıs'ta Profesyonel Ev, Ofis ve Derin Temizlik Hizmeti",
    'hero.subtitle': "Kıbrıs'ın güvenilir temizlik şirketi olarak ev temizliği, ofis temizliği, derin temizlik, halı & koltuk yıkama, dış cephe cam temizliği, inşaat sonrası temizlik ve dezenfeksiyon hizmetlerini deneyimli ekibimizle aynı gün, garantili ve uygun fiyatlarla sunuyoruz.",
    'services.tag': 'Uzmanlık Alanlarımız',
    'services.title': 'Hizmetlerimiz',
    'services.desc': "Gündelik ev temizliğinden derin temizliğe, halı & koltuk yıkamadan dış cephe cam temizliği ve inşaat sonrası temizliğe kadar Kıbrıs'ta ihtiyacınız olan tüm temizlik hizmetlerini tek çatı altında titizlikle sağlıyoruz.",
    ...
    'svc.carpet.text': "Kıbrıs'ta halı yıkama hizmeti; halılarınızı toz akarlarından ve bakterilerden arındırarak profesyonel makinelerle yıkıyoruz. Ücretsiz alım-teslim ve yerinde halı yıkama seçenekleriyle pırıl pırıl sonuçlar.",
    ...
    'why.tag': 'Neden Kıbrıs Temiz?',
    'why.title': 'Bizi Neden Tercih Etmelisiniz?',
    'why.desc': "Kıbrıs genelinde mobil ekiplerimizle ve tecrübeli kadın temizlik işçilerimizle pırıl pırıl, güvenilir ve garantili hizmet sunuyoruz.",
    'why.card1.title': 'Aynı Gün Hizmet',
    'why.card1.text': "Kıbrıs içinde hızlı organizasyon sağlayarak ihtiyacınız olan günde adresinize gelip temizlik hizmetini başlatıyoruz.",
    ...
    'faq.q5.q': "Kıbrıs'ta temizlik ücretleri ne kadar?",
    ...
    'faq.q9.q': "Kıbrıs'ta halı ve koltuk yıkama fiyatları ne kadar?",
    ...
    'regions.desc': "Mobil servis araçlarımız ve personellerimizle Kıbrıs'ın tüm şehir ve bölgelerine aynı gün ev temizliği, ofis temizliği, halı yıkama ve derin temizlik hizmeti sağlıyoruz.",
    'regions.note': "Kıbrıs'ın tüm şehirlerine ve çevre bölgelerine hızlı ulaşım sağlayan temizlik kadromuz mevcuttur.",
    ...
    'details.location.text': "Fiziki ofisimiz bulunmamaktadır. Kıbrıs'ın tüm ilçe ve bölgelerine <strong>adresten adrese mobil temizlik</strong> hizmeti vermekteyiz.",
    ...
    'footer.desc': "Kıbrıs'ta 7/24 güvenilir ev temizliği, ofis temizliği, derin temizlik, halı & koltuk yıkama, dış cephe cam temizliği ve inşaat sonrası temizlik hizmetleri sunan profesyonel temizlik şirketi. Hijyenik konfor sunuyoruz.",
    'footer.linksTitle': 'Hızlı Linkler',
    'footer.galleryLink': 'Önce/Sonra Galeri',
    'footer.waLink': 'WhatsApp Destek Hattı',
    'footer.copyright': '© 2026 Kıbrıs Temizlik Hizmetleri. Tüm hakları saklıdır.',
  ...
  var EN = {
    ...
    'hero.badge': '24/7 Cyprus Cleaning Company',
    'hero.title': 'Professional Home, Office & Deep Cleaning in Cyprus',
    'hero.subtitle': 'As Cyprus\'s trusted cleaning company, we provide home cleaning, office cleaning, deep cleaning, carpet & sofa washing, facade and window cleaning, post-construction cleaning and disinfection — same-day, guaranteed and at fair prices with our experienced team.',
    'services.tag': 'Our Areas of Expertise',
    'services.title': 'Our Services',
    'services.desc': 'From routine home cleaning and deep cleaning to carpet & sofa washing, facade window cleaning and post-construction cleaning, we provide every cleaning service you need in Cyprus under one roof.',
    ...
    'svc.carpet.text': 'Carpet washing service in Cyprus; we wash your carpets with professional machines, purifying them from dust mites and bacteria. Free pick-up & delivery and on-site carpet washing options for spotless results.',
    ...
    'why.tag': 'Why Cyprus Temiz?',
    'why.title': 'Why Choose Us?',
    'why.desc': 'We offer sparkling, reliable and guaranteed service throughout Cyprus with our mobile teams and experienced female cleaning workers.',
    'why.card1.title': 'Same-Day Service',
    'why.card1.text': 'By providing fast organization in Cyprus, we come to your address and start the cleaning service on the day you need it.',
    ...
    'faq.q5.q': 'How much are cleaning fees in Cyprus?',
    ...
    'faq.q9.q': 'How much are carpet and sofa washing prices in Cyprus?',
    ...
    'regions.desc': 'With our mobile service vehicles and staff, we provide same-day cleaning service to all cities and areas of Cyprus.',
    'regions.note': 'We have a cleaning staff that provides fast access to all cities and surrounding regions of Cyprus.',
    ...
    'details.location.text': 'We do not have a physical office. We provide <strong>on-site mobile cleaning service</strong> to all cities and districts of Cyprus.',
    ...
    'footer.desc': 'Your professional cleaning company in Cyprus, offering reliable 24/7 home cleaning, office cleaning, deep cleaning, carpet & sofa washing, facade window cleaning and post-construction cleaning. We offer hygienic comfort.',
    'footer.linksTitle': 'Quick Links',
    'footer.galleryLink': 'Before/After Gallery',
    'footer.waLink': 'WhatsApp Support Line',
    'footer.copyright': '© 2026 Cyprus Cleaning Services. All rights reserved.',
    'footer.tagline': 'Designed with care for local business SEO.'
  };
  ...
  var DE = {
    ...
    'hero.badge': '24/7 Reinigungsfirma in Zypern',
    'hero.title': 'Professionelle Wohnungs-, Büro- & Tiefenreinigung in Zypern',
    'hero.subtitle': 'Als zuverlässige Reinigungsfirma in Zypern bieten wir Wohnungsreinigung, Büroreinigung, Tiefenreinigung, Teppich- & Polsterwäsche, Fassaden- und Fensterreinigung, Baureinigung und Desinfektion – taggleich, garantiert und zu fairen Preisen mit unserem erfahrenen Team.',
    'services.tag': 'Unsere Fachgebiete',
    'services.title': 'Unsere Leistungen',
    'services.desc': 'Von der täglichen Hausreinigung über die Tiefenreinigung, Teppich- & Polsterwäsche bis hin zur Fassadenfenster- und Baureinigung bieten wir Ihnen alle Reinigungsdienste in Zypern aus einer Hand.',
    ...
    'svc.carpet.text': 'Teppichwäsche in Zypern; wir waschen Ihre Teppiche mit professionellen Maschinen und befreien sie von Hausstaubmilben und Bakterien. Kostenlose Abholung & Lieferung und Vor-Ort-Reinigung für makellose Ergebnisse.',
    ...
    'why.tag': 'Warum Cyprus Temiz?',
    'why.title': 'Warum sollten Sie uns wählen?',
    'why.desc': 'Wir bieten blitzsauberen, zuverlässigen und garantierten Service in ganz Zypern mit unseren mobilen Teams und erfahrenen Reinigungskräften.',
    'why.card1.title': 'Service am selben Tag',
    'why.card1.text': 'Durch die schnelle Organisation in Zypern kommen wir an dem Tag, an dem Sie uns brauchen, zu Ihnen nach Hause.',
    ...
    'faq.q5.q': 'Wie hoch sind die Reinigungskosten in Zypern?',
    ...
    'faq.q9.q': 'Wie hoch sind die Preise für Teppich- und Polsterwäsche in Zypern?',
    ...
    'regions.desc': 'Mit unseren mobilen Servicefahrzeugen und unserem Personal bieten wir allen Städten und Gebieten Zyperns taggleichen Service.',
    'regions.note': 'Wir verfügen über Reinigungskräfte, die alle Städte Zyperns und die umliegenden Gebiete schnell erreichen.',
    'contact.tag': 'Kontakt',
    ...
    'details.location.text': 'Wir haben kein physisches Büro. Wir bieten <strong>mobilen Service vor Ort</strong> in allen Städten und Bezirken Zyperns.',
    ...
    'footer.desc': 'Ihre professionelle Reinigungsfirma in Zypern für zuverlässige 24/7-Hausreinigung, Büroreinigung, Tiefenreinigung, Teppich- & Polsterwäsche, Fassadenfensterreinigung und Baureinigung. Wir sorgen für hygienischen Komfort.',
    'footer.linksTitle': 'Schnelllinks',
    'footer.galleryLink': 'Vorher/Nachher-Galerie',
    'footer.waLink': 'WhatsApp-Support',
    'footer.copyright': '© 2026 Zypern Reinigungsdienste. Alle Rechte vorbehalten.',
  ...
  var RU = {
    ...
    'hero.badge': '24/7 Клининговая компания на Кипре',
    'hero.title': 'Профессиональная уборка квартир, офисов и генуборка на Кипре',
    'hero.subtitle': 'Как надежная клининговая компания на Кипре мы предлагаем уборку квартир и офисов, генеральную уборку, химчистку ковров и диванов, мытье окон и фасадов, послестроительную уборку и дезинфекцию — в тот же день, с гарантией и по доступным ценам силами опытной команды.',
    'services.tag': 'Наши направления',
    'services.title': 'Наши услуги',
    'services.desc': 'От ежедневной уборки квартир и генеральной уборки до химчистки ковров и диванов, мытья фасадных окон и послестроительной уборки — мы предоставляем все клининговые услуги на Кипре под одной крышей.',
    ...
    'svc.carpet.text': 'Химчистка ковров на Кипре; мы стираем ваши ковры на профессиональном оборудовании, очищая их от пылевых клещей и бактерий. Бесплатный вывоз и доставка, а также чистка на дому для безупречного результата.',
    ...
    'why.tag': 'Почему Cyprus Temiz?',
    'why.title': 'Почему выбирают нас?',
    'why.desc': 'Мы предлагаем безупречный, надежный и гарантированный сервис по всему Кипру силами наших мобильных бригад и опытного персонала.',
    'why.card1.title': 'Обслуживание в тот же день',
    'why.card1.text': 'Благодаря оперативной координации на Кипре мы выезжаем на объект в тот же день, когда вам требуется уборка.',
    ...
    'faq.q5.q': 'Сколько стоит уборка на Кипре?',
    ...
    'faq.q9.q': 'Сколько стоит химчистка ковров и диванов на Кипре?',
    ...
    'regions.desc': 'С нашими мобильными бригадами мы предоставляем услуги уборки в тот же день во всех городах и районах Кипра.',
    'regions.note': 'У нас работают специалисты, которые быстро добираются в любой город Кипра и близлежащие округа.',
    ...
    'details.location.text': 'У нас нет физического офиса. Мы предоставляем <strong>выездной клининг на объекте</strong> во всех городах и районах Кипра.',
    ...
    'footer.desc': 'Ваша профессиональная клининговая компания на Кипре: надежная уборка квартир и офисов, генеральная уборка, химчистка ковров и диванов, мытье фасадных окон и послестроительный клининг 24/7. Обеспечиваем гигиенический комфорт.',
    'footer.linksTitle': 'Быстрые ссылки',
    'footer.galleryLink': 'Галерея До/После',
    'footer.waLink': 'Линия поддержки WhatsApp',
    'footer.copyright': '© 2026 Клининговые услуги на Кипре. Все права защищены.',
