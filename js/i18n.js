/* Manavgat Temizlik - Çok Dilli Site (TR / EN / DE / RU) */
(function () {
  'use strict';
  ...
  var META = {
    tr: {
      title: 'Manavgat Temizlik Şirketi | Ev, Ofis, Derin Temizlik & Halı Yıkama',
      description: "Manavgat temizlik şirketi: profesyonel ev temizliği, ofis temizliği, derin temizlik, halı & koltuk yıkama, cam ve dış cephe temizliği, inşaat sonrası temizlik ve dezenfeksiyon. Günlük ve saatlik temizlikçi, tatil evi & villa temizliği. Side, Kızılağaç, Çolaklı, Evrenseki aynı gün hizmet. ☎ 0534 350 36 30"
    },
    en: {
      title: 'Manavgat Cleaning Company | Home, Office, Deep Cleaning & Carpet Wash',
      description: 'Manavgat cleaning company: professional home cleaning, office cleaning, deep cleaning, carpet & sofa washing, window and facade cleaning, post-construction cleaning and disinfection. Daily & hourly cleaners, holiday home & villa cleaning. Same-day service. ☎ +90 534 350 36 30'
    },
    de: {
      title: 'Reinigungsfirma Manavgat | Haus, Büro, Tiefenreinigung & Teppichwäsche',
      description: 'Reinigungsfirma in Manavgat: professionelle Wohnungsreinigung, Büroreinigung, Tiefenreinigung, Teppich- & Polsterwäsche, Fenster- und Fassadenreinigung, Baureinigung und Desinfektion. Ferienwohnungs- & Villenreinigung, Reinigungskräfte stundenweise. Service am selben Tag. ☎ +90 534 350 36 30'
    },
    ru: {
      title: 'Клининговая компания в Манавгате | Дом, офис, генуборка, химчистка',
      description: 'Клининговая компания в Манавгате: профессиональная уборка квартир и офисов, генеральная уборка, химчистка ковров и диванов, мытье окон и фасадов, послестроительная уборка и дезинфекция. Уборка вилл и апартаментов посуточно, уборщица на час. Обслуживание в тот же день. ☎ +90 534 350 36 30'
    }
  };
  ...
  var TR = {
    ...
    'hero.badge': '7/24 Manavgat Temizlik Şirketi',
    'hero.title': "Manavgat'ta Profesyonel Ev, Ofis ve Derin Temizlik Hizmeti",
    'hero.subtitle': "Manavgat'ın güvenilir temizlik şirketi olarak ev temizliği, ofis temizliği, derin temizlik, halı & koltuk yıkama, dış cephe cam temizliği, inşaat sonrası temizlik ve dezenfeksiyon hizmetlerini deneyimli ekibimizle aynı gün, garantili ve uygun fiyatlarla sunuyoruz.",
    'services.tag': 'Uzmanlık Alanlarımız',
    'services.title': 'Hizmetlerimiz',
    'services.desc': "Gündelik ev temizliğinden derin temizliğe, halı & koltuk yıkamadan dış cephe cam temizliği ve inşaat sonrası temizliğe kadar Manavgat'ta ihtiyacınız olan tüm temizlik hizmetlerini tek çatı altında titizlikle sağlıyoruz.",
    ...
    'svc.carpet.text': "Manavgat'ta halı yıkama hizmeti; halılarınızı toz akarlarından ve bakterilerden arındırarak profesyonel makinelerle yıkıyoruz. Ücretsiz alım-teslim ve yerinde halı yıkama seçenekleriyle pırıl pırıl sonuçlar.",
    ...
    'svc.holiday.link': 'Detaylı Bilgi & Ara',
    ...
    'why.tag': 'Neden Manavgat Temiz?',
    'why.title': 'Bizi Neden Tercih Etmelisiniz?',
    'why.desc': "Manavgat genelinde mobil ekiplerimizle ve tecrübeli kadın temizlik işçilerimizle pırıl pırıl, güvenilir ve garantili hizmet sunuyoruz.",
    'why.card1.title': 'Aynı Gün Hizmet',
    'why.card1.text': "Manavgat içinde hızlı organizasyon sağlayarak ihtiyacınız olan günde adresinize gelip temizlik hizmetini başlatıyoruz.",
    ...
    'faq.q5.q': "Manavgat'ta temizlik ücretleri ne kadar?",
    ...
    'faq.q9.q': "Manavgat'ta halı ve koltuk yıkama fiyatları ne kadar?",
    ...
    'regions.desc': "Mobil servis araçlarımız ve personellerimizle Manavgat'ın tüm mahallelerine ve çevre bölgelerine aynı gün ev temizliği, ofis temizliği, halı yıkama ve derin temizlik hizmeti sağlıyoruz.",
    'regions.note': "Manavgat'ın tüm mahallelerine ve çevre ilçelerine hızlı ulaşım sağlayan temizlik kadromuz mevcuttur.",
    ...
    'details.location.text': "Fiziki ofisimiz bulunmamaktadır. Manavgat'ın tüm mahalle ve ilçelerine <strong>adreste adrese mobil temizlik</strong> hizmeti vermekteyiz.",
    ...
    'footer.desc': "Manavgat'ta 7/24 güvenilir ev temizliği, ofis temizliği, derin temizlik, halı & koltuk yıkama, dış cephe cam temizliği ve inşaat sonrası temizlik hizmetleri sunan profesyonel temizlik şirketi. Hijyenik konfor sunuyoruz.",
    'footer.linksTitle': 'Hızlı Linkler',
    'footer.galleryLink': 'Önce/Sonra Galeri',
    'footer.waLink': 'WhatsApp Destek Hattı',
    'footer.copyright': '© 2026 Manavgat Temizlik Hizmetleri. Tüm hakları saklıdır.',
  ...
  var EN = {
    ...
    'hero.badge': '24/7 Manavgat Cleaning Company',
    'hero.title': 'Professional Home, Office & Deep Cleaning in Manavgat',
    'hero.subtitle': 'As Manavgat\'s trusted cleaning company, we provide home cleaning, office cleaning, deep cleaning, carpet & sofa washing, facade and window cleaning, post-construction cleaning and disinfection — same-day, guaranteed and at fair prices with our experienced team.',
    'services.tag': 'Our Areas of Expertise',
    'services.title': 'Our Services',
    'services.desc': 'From routine home cleaning and deep cleaning to carpet & sofa washing, facade window cleaning and post-construction cleaning, we provide every cleaning service you need in Manavgat under one roof.',
    ...
    'svc.carpet.text': 'Carpet washing service in Manavgat; we wash your carpets with professional machines, purifying them from dust mites and bacteria. Free pick-up & delivery and on-site carpet washing options for spotless results.',
    ...
    'svc.holiday.link': 'Learn More & Call',
    ...
    'why.tag': 'Why Manavgat Temiz?',
    'why.title': 'Why Choose Us?',
    'why.desc': 'We offer sparkling, reliable and guaranteed service throughout Manavgat with our mobile teams and experienced female cleaning workers.',
    'why.card1.title': 'Same-Day Service',
    'why.card1.text': 'By providing fast organization in Manavgat, we come to your address and start the cleaning service on the day you need it.',
    ...
    'faq.q5.q': 'How much are cleaning fees in Manavgat?',
    ...
    'faq.q9.q': 'How much are carpet and sofa washing prices in Manavgat?',
    ...
    'regions.desc': 'With our mobile service vehicles and staff, we provide same-day cleaning service to all neighborhoods of Manavgat and surrounding areas.',
    'regions.note': 'We have a cleaning staff that provides fast access to all neighborhoods and surrounding districts of Manavgat.',
    ...
    'details.location.text': 'We do not have a physical office. We provide <strong>on-site mobile cleaning service</strong> to all neighborhoods and districts of Manavgat.',
    ...
    'footer.desc': 'Your professional cleaning company in Manavgat, offering reliable 24/7 home cleaning, office cleaning, deep cleaning, carpet & sofa washing, facade window cleaning and post-construction cleaning. We offer hygienic comfort.',
    'footer.linksTitle': 'Quick Links',
    'footer.galleryLink': 'Before/After Gallery',
    'footer.waLink': 'WhatsApp Support Line',
    'footer.copyright': '© 2026 Manavgat Cleaning Services. All rights reserved.',
    'footer.tagline': 'Designed with care for local business SEO.'
  };
  ...
  var DE = {
    ...
    'hero.badge': '24/7 Reinigungsfirma in Manavgat',
    'hero.title': 'Professionelle Wohnungs-, Büro- & Tiefenreinigung in Manavgat',
    'hero.subtitle': 'Als zuverlässige Reinigungsfirma in Manavgat bieten wir Wohnungsreinigung, Büroreinigung, Tiefenreinigung, Teppich- & Polsterwäsche, Fassaden- und Fensterreinigung, Baureinigung und Desinfektion – taggleich, garantiert und zu fairen Preisen mit unserem erfahrenen Team.',
    'services.tag': 'Unsere Fachgebiete',
    'services.title': 'Unsere Leistungen',
    'services.desc': 'Von der täglichen Hausreinigung über die Tiefenreinigung, Teppich- & Polsterwäsche bis hin zur Fassadenfenster- und Baureinigung bieten wir Ihnen alle Reinigungsdienste in Manavgat aus einer Hand.',
    ...
    'svc.carpet.text': 'Teppichwäsche in Manavgat; wir waschen Ihre Teppiche mit professionellen Maschinen und befreien sie von Hausstaubmilben und Bakterien. Kostenlose Abholung & Lieferung und Vor-Ort-Reinigung für makellose Ergebnisse.',
    ...
    'svc.holiday.link': 'Mehr erfahren & anrufen',
    ...
    'why.tag': 'Warum Manavgat Temiz?',
    'why.title': 'Warum sollten Sie uns wählen?',
    'why.desc': 'Wir bieten blitzsauberen, zuverlässigen und garantierten Service in ganz Manavgat mit unseren mobilen Teams und erfahrenen Reinigungskräften.',
    'why.card1.title': 'Service am selben Tag',
    'why.card1.text': 'Durch die schnelle Organisation in Manavgat kommen wir an dem Tag, an dem Sie uns brauchen, zu Ihnen nach Hause.',
    ...
    'faq.q5.q': 'Wie hoch sind die Reinigungskosten in Manavgat?',
    ...
    'faq.q9.q': 'Wie hoch sind die Preise für Teppich- und Polsterwäsche in Manavgat?',
    ...
    'regions.desc': 'Mit unseren mobilen Servicefahrzeugen und unserem Personal bieten wir allen Stadtteilen Manavgats und den umliegenden Gebieten taggleichen Service.',
    'regions.note': 'Wir verfügen über Reinigungskräfte, die alle Stadtteile Manavgats und die umliegenden Bezirke schnell erreichen.',
    'contact.tag': 'Kontakt',
    ...
    'details.location.text': 'Wir haben kein physisches Büro. Wir bieten <strong>mobilen Service vor Ort</strong> in allen Stadtteilen und Bezirken Manavgats.',
    ...
    'footer.desc': 'Ihre professionelle Reinigungsfirma in Manavgat für zuverlässige 24/7-Hausreinigung, Büroreinigung, Tiefenreinigung, Teppich- & Polsterwäsche, Fassadenfensterreinigung und Baureinigung. Wir sorgen für hygienischen Komfort.',
    'footer.linksTitle': 'Schnelllinks',
    'footer.galleryLink': 'Vorher/Nachher-Galerie',
    'footer.waLink': 'WhatsApp-Support',
    'footer.copyright': '© 2026 Manavgat Reinigungsdienste. Alle Rechte vorbehalten.',
  ...
  var RU = {
    ...
    'hero.badge': '24/7 Клининговая компания в Манавгате',
    'hero.title': 'Профессиональная уборка квартир, офисов и генуборка в Манавгате',
    'hero.subtitle': 'Как надежная клининговая компания в Манавгате мы предлагаем уборку квартир и офисов, генеральную уборку, химчистку ковров и диванов, мытье окон и фасадов, послестроительную уборку и дезинфекцию — в тот же день, с гарантией и по доступным ценам силами опытной команды.',
    'services.tag': 'Наши направления',
    'services.title': 'Наши услуги',
    'services.desc': 'От ежедневной уборки квартир и генеральной уборки до химчистки ковров и диванов, мытья фасадных окон и послестроительной уборки — мы предоставляем все клининговые услуги в Манавгате под одной крышей.',
    ...
    'svc.carpet.text': 'Химчистка ковров в Манавгате; мы стираем ваши ковры на профессиональном оборудовании, очищая их от пылевых клещей и бактерий. Бесплатный вывоз и доставка, а также чистка на дому для безупречного результата.',
    ...
    'svc.holiday.link': 'Подробнее и позвонить',
    ...
    'why.tag': 'Почему Manavgat Temiz?',
    'why.title': 'Почему выбирают нас?',
    'why.desc': 'Мы предлагаем безупречный, надежный и гарантированный сервис по всей Манавгате силами наших мобильных бригад и опытного персонала.',
    'why.card1.title': 'Обслуживание в тот же день',
    'why.card1.text': 'Благодаря оперативной координации в Манавгате мы выезжаем на объект в тот же день, когда вам требуется уборка.',
    ...
    'faq.q5.q': 'Сколько стоит уборка в Манавгате?',
    ...
    'faq.q9.q': 'Сколько стоит химчистка ковров и диванов в Манавгате?',
    ...
    'regions.desc': 'С нашими мобильными бригадами мы предоставляем услуги уборки в тот же день во всех районах Манавгата и окрестностях.',
    'regions.note': 'У нас работают специалисты, которые быстро добираются в любой район Манавгата и близлежащие округа.',
    ...
    'details.location.text': 'У нас нет физического офиса. Мы предоставляем <strong>выездной клининг на объекте</strong> во всех районах и округах Манавгата.',
    ...
    'footer.desc': 'Ваша профессиональная клининговая компания в Манавгате: надежная уборка квартир и офисов, генеральная уборка, химчистка ковров и диванов, мытье фасадных окон и послестроительный клининг 24/7. Обеспечиваем гигиенический комфорт.',
    'footer.linksTitle': 'Быстрые ссылки',
    'footer.galleryLink': 'Галерея До/После',
    'footer.waLink': 'Линия поддержки WhatsApp',
    'footer.copyright': '© 2026 Клининговые услуги в Манавгате. Все права защищены.',
